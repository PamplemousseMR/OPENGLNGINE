...
HardwareVertexBuffer::HardwareVertexBuffer(HardwareBufferManager* const _manager, HARDWAREVERTEXBUFFER_TYPE _type, size_t _numVertices, HARDWAREBUFFER_USAGE _usage):
